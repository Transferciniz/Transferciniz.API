...
namespace Transferciniz.API.Migrations
{
    ...
    [Migration("20240810132655_session")]
            ...
            modelBuilder.Entity("Transferciniz.API.Entities.User", b =>
                {
                    ...
                    b.HasOne("Transferciniz.API.Entities.Session", "Session")
                        .WithMany()
                        .HasForeignKey("SessionId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Transferciniz.API.Entities.UserDevice", "UserDevice")
                        .WithMany()
                        .HasForeignKey("UserDeviceId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
